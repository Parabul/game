...
public class TensorFlowStateEvaluatorTest {
  ...
  public void evaluateMaxDiff() {
    ...
    assertThat(stateEvaluator.evaluate(state, Player.ONE)).isWithin(0.01).of(0.999);
    assertThat(stateEvaluator.evaluate(state, Player.TWO)).isWithin(0.01).of(0.001);
  }
  ...
  public void evaluateNegativeDiff() {
    ...
    assertThat(stateEvaluator.evaluate(state, Player.ONE)).isWithin(0.1).of(0.027);
    assertThat(stateEvaluator.evaluate(state, Player.TWO)).isWithin(0.1).of(0.973);
  }
}
