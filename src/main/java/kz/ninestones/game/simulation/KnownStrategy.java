...
import kz.ninestones.game.modeling.evaluation.ScoreStateEvaluator;
import kz.ninestones.game.modeling.strategy.FirstAllowedMoveStrategy;
import kz.ninestones.game.modeling.strategy.MatrixMinMaxStrategy;
import kz.ninestones.game.modeling.strategy.MaxStrategy;
...
public enum KnownStrategy {
  ...
  NEURAL_NET_3(new MatrixMinMaxStrategy(new NeuralNetStateEvaluator(
